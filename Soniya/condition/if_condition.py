...
# round3="pass"
# if (round1=="Pass"):
#     print(" congrts for round1")
#     if(round2=="Pass"):
#         print(" congrats for second round")
#         if(round3=="Pass"):
#             print("congrts for third round")
#         else:
#             print(" failed in third round")
#     else:
#         print("failed in second round")
# else:
#     print("failled in round1,try for next round")
...
# x=int(input("enter the x value"))
# if x %3==0 and x %5==0:
#     print("both are divived by 3 and 5")
# else:
...
x=int(input("enter the x value"))
if x %3 ===0 or x %5==0:
    print("numberis divided by or 3 or 5")
else:
    print ()
