...
"""
Properties:
1. Integer is immutable(cant be manipulated ) data type. once it is defined can not update.
2. Integer only contains whole number , 1, 3, 45, 789.
3. There is no specific range for integer data type.(0 to infinity)
"""
n1 = 0
n2 = 1
n3 = 7878798798
